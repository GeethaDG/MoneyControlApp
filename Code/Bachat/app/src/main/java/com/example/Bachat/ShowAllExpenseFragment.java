...
public class ShowAllExpenseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.show_all_screen, container, false);
        myDb = new DatabaseHelper(getActivity());
        Log.d(TAG, "onCreate: created ViewAll screen");

        //Initialising and linking resources for filtering functionality
        daySelected = (Spinner) view.findViewById(R.id.spnDate);
        monthSelected = (Spinner) view.findViewById(R.id.spnMonth);
        yearSelected = (Spinner) view.findViewById(R.id.spnYear);
        filterOptionsSelected = (Spinner) view.findViewById(R.id.spnOptions);
        categorySelected = (Spinner) view.findViewById(R.id.spnCategory);
        getDetails = (Button) view.findViewById(R.id.btnFilter);


        //Spinner for options
        ArrayAdapter<String> optionsAdapter;
        //String[] filterOptions = {"Show all", "Category Only", "Date Only", "Date and Category"};
        Spinner optionsSpinner = (Spinner) view.findViewById(R.id.spnOptions);
        optionsAdapter = new ArrayAdapter<String>(getActivity(), android.R.layout.simple_list_item_1, filterOptions);
        ...
        optionsSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view1, int position, long id) {
                ...
                if (options == "Date Only" || options == "Date and Category"){
                    ...
                    Spinner yearSpinner = (Spinner) view.findViewById(R.id.spnYear);
                    ...
                    Spinner monthSpinner = (Spinner) view.findViewById(R.id.spnMonth);
        ...
        ListView listshowall= (ListView) view.findViewById(R.id.listFilter);

        viewData();
        Log.d(TAG, "onCreate: values are"+filterOptionsSelected + "" + categorySelected + "" + yearSelected + "" + monthSelected);

        //Home Button
        Button lastbutton = (Button) view.findViewById(R.id.btnLast);
    ...
    public void dateSetting(int yearChosen, int monthChosen,View v){
        ...
        Spinner daySpinner = (Spinner) v.findViewById(R.id.spnDate);
    ...
    public void viewData() {
        ...
        getDetails.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                ListView listshowall= (ListView) v.findViewById(R.id.listFilter);
                ...
                ViewAllAdapter listAdapter = new ViewAllAdapter(getActivity(), R.layout.view_all_layout,ListItems);
                ...
                listshowall.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Intent intent = new Intent(getActivity(), EditScreen.class);
